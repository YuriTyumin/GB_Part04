...
# start = int(input(f'Введите начальное значение для генерации последовательности чисел: '))
# end = int(input(f'Введите конечное значение для генерации последовательности чисел: '))
...
# my_list = input(f'Введите последовательность символов для генерации: ')
# max_count = int(input(f'Введите значение кол-ва символов в итоговой последовательности: '))
# с = 0
...
# max_fact = int(input(f'Введите число, до которого нужно считать факториал: '))
# def fact():
#     for x in range(1, max_fact + 1):
#         yield factorial(x)
#
# for x in fact():
#     print(x)
